 ...
 */
exports.wineries = function(func) {
	var uri = '/search/wineries/all';
	var client = http.createClient(80, cruvee.appUrl);
	var req = client.request('GET', uri, {
		'Host': cruvee.appUrl,
		'Authorization': cruvee.getAuth(uri)
	});
	req.end();
 ...
 * @class exports.wines
 */
exports.wines = function(func) {
	var uri = '/search/wines/all';
	func.apply(this, ['not implemented']);
};
...
cruvee.getAuth = function(uri) {
	...
	sig += timestamp + "\n";
	sig += uri + "\n";
	sig = this.md5(sig.toLowerCase());
	return 'Cruvee appId="' + this.appId + '", sig="' + sig + '", timestamp="' + timestamp + '", uri="' + uri + '"';
}

/**
 * @class cruvee.utf8_encode
 */
cruvee.utf8_encode = function(argString) {
